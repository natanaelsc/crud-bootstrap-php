<?php 
/**
 *  Listagem de Registros e Página Principal do Modulo de Clientes 
 * */
    require_once('functions.php'); /** Ligação com Modulo de Clientes */
    index(); /** Chamada de Função Backend da Página */
?>

<?php include(HEADER_TEMPLATE); /** Importa "inc/header.php" para a página */ ?>
...
<?php if (!empty($_SESSION['message'])) : /** Verificação de Mensagens de Erro ou Sucesso */ ?>
...
<tbody>
<?php if ($customers) : ?>
<?php foreach ($customers as $customer) : /** Listagem de Clientes */ ?>
	<tr>
...
<?php include(FOOTER_TEMPLATE); /** Importa "inc/footer.php" para a página */ ?>